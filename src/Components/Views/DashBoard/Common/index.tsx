...
export const ChannelImage: FC<IChannelImageProps> = (props) => {
  return (
    <img
      src={props.Thumb ? props.Thumb : `/api/user/v2/YoutubeReport/ChannelAvatar?Id=${props.Id}`}
...
export const VideoImage: FC<IVideoImageProps> = (props) => {
  return (
    <img
      src={props.Thumb ? props.Thumb : `/api/user/v2/YoutubeReport/VideoThumb?Id=${props.Id}`}
...
export const RowTitle: FC<TitleProps> = (props) => {
  ...
  return (
    <Box component={'a'} target={'_blank'} href={getUrl()} sx={{ display: 'flex', alignItems: 'center', textDecoration: 'none' }}>
